...
plot_bp_2 = Blueprint('plot_bp_2', __name__)


@plot_bp_2.route('/interactive_plot_2')
def interactive_plot():
    processed_data, _ = load_data()
    fig1 = break_out_figure(processed_data)
    fig1 = add_buttons_figure(fig1)
    with open('./templates/testing_graph.html', 'w') as f:
        f.write(fig1.to_html(full_html=False, include_plotlyjs='cdn'))
    return render_template("testing_graph.html")
...
def break_out_figure(processed_data):
    ...
    y_buy1 = processed_data['buy_1']
    y_sell1 = processed_data['sell_1']
    #y_buy2 = processed_data['buy_2']
    ...
    fig = make_subplots(
        ...
        x_title='Date',
        subplot_titles=('Testing Algo',  'Buy Signals')
    )
    fig.add_scatter(
        x=x,
        y=y1,
